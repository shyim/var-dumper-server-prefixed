 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoper5d36eb080763e\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * @return \DOMDocument
     */
    public function getInputDefinitionDocument(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition $definition)
    {
     ...
     * @return \DOMDocument
     */
    public function getCommandDocument(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Command\Command $command)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
     ...
     * @return \DOMDocument
     */
    public function getApplicationDocument(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Application $application, $namespace = null)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
