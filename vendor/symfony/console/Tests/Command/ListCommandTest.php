...
class ListCommandTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    public function testExecuteListsCommands()
    {
        $application = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Application();
        $commandTester = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Tester\CommandTester($command = $application->get('list'));
...
EOF;
    ...
    public function testExecuteListsCommandsOrder()
    {
        ...
        $application = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Application();
        $application->add(new \_PhpScoper5d36eb080763e\Foo6Command());
        $commandTester = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Tester\CommandTester($command = $application->get('list'));
        $commandTester->execute(['command' => $command->getName()], ['decorated' => \false]);
        $output = <<<'EOF'
Console Tool
