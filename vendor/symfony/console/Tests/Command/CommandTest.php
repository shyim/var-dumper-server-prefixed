...
class CommandTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Command\Command('foo:bar');
    ...
    {
        (new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Application())->add(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Command\Command());
    }
    public function testSetApplication()
    {
        $application = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Application();
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $ret = $command->setDefinition($definition = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition());
        ...
        $command->setDefinition([new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputArgument('foo'), new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputOption('bar')]);
        ...
        $command->setDefinition(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition());
    }
    ...
    public function testGetHelper()
    {
        ...
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $command->setApplication($application);
        $formatterHelper = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Helper\FormatterHelper();
    ...
    {
        $application1 = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Application();
        $application1->getDefinition()->addArguments([new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputArgument('foo')]);
        $application1->getDefinition()->addOptions([new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputOption('bar')]);
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $command->setApplication($application1);
        $command->setDefinition($definition = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition([new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputArgument('bar'), new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputOption('foo')]));
    ...
    public function testMergeApplicationDefinitionWithoutArgsThenWithArgsAddsArgs()
    {
        ...
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $command->setApplication($application1);
        $command->setDefinition($definition = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition([]));
        $r = new \ReflectionObject($command);
        $m = $r->getMethod('mergeApplicationDefinition');
        $m->setAccessible(\true);
    ...
    {
        $tester = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Tester\CommandTester(new \_PhpScoper5d36eb080763e\TestCommand());
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Command\Command('foo');
        $command->run(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\StringInput(''), new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\NullOutput());
    }
    /**
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $exitCode = $command->run(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\StringInput(''), new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\NullOutput());
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $this->assertSame(0, $command->run(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\StringInput(''), new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\NullOutput()));
    }
    ...
    {
        $command = new \_PhpScoper5d36eb080763e\TestCommand();
        $ret = $command->setCode(function (\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface $output) {
    ...
    public function callableMethodCommand(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface $output)
    {
        $output->writeln('from the code...');
    }
}
...
{
    return function (\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface $output) {
        $output->writeln($this instanceof \_PhpScoper5d36eb080763e\Symfony\Component\Console\Command\Command ? 'bound to the command' : 'not bound to the command');
    };
}
