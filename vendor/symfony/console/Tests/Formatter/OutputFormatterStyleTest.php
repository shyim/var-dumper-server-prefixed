...
class OutputFormatterStyleTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $style = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Formatter\OutputFormatterStyle('green', 'black', ['bold', 'underscore']);
        $this->assertEquals("\33[32;40;1;4mfoo\33[39;49;22;24m", $style->apply('foo'));
        $style = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Formatter\OutputFormatterStyle('red', null, ['blink']);
        $this->assertEquals("\33[31;5mfoo\33[39;25m", $style->apply('foo'));
        $style = new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Formatter\OutputFormatterStyle(null, 'white');
