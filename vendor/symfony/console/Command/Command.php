...
class Command
{
    ...
    public function setApplication(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Application $application = null)
    {
    ...
    {
        throw new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Exception\LogicException('You must override the execute() method in the concrete command class.');
    }
    /**
     ...
     */
    protected function initialize(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface $output)
    {
    }
    /**
     * Runs the command.
     ...
     * @see execute()
     */
    public function run(\_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        if (null !== $this->processTitle) {
            if (\function_exists('cli_set_process_title')) {
                if (!@\cli_set_process_title($this->processTitle)) {
                    if ('Darwin' === \PHP_OS) {
                        $output->writeln('<comment>Running "cli_set_process_title" as an unprivileged user is not supported on MacOS.</comment>', \_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE);
                    } else {
                        \cli_set_process_title($this->processTitle);
                    }
                }
            } elseif (\function_exists('_PhpScoper5d36eb080763e\\setproctitle')) {
                setproctitle($this->processTitle);
            } elseif (\_PhpScoper5d36eb080763e\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE === $output->getVerbosity()) {
    ...
    {
        if ($definition instanceof \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputDefinition) {
    ...
    {
        $this->definition->addArgument(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputArgument($name, $mode, $description, $default));
        return $this;
    }
    /**
     * Adds an option.
    ...
    {
        $this->definition->addOption(new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Input\InputOption($name, $shortcut, $mode, $description, $default));
        return $this;
    }
    /**
    ...
    public function setAliases($aliases)
    {
        if (!\is_array($aliases) && !$aliases instanceof \Traversable) {
            throw new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Exception\InvalidArgumentException('$aliases must be an array or an instance of \\Traversable');
        }
    ...
    {
        if (!\preg_match('/^[^\\:]++(\\:[^\\:]++)*$/', $name)) {
            throw new \_PhpScoper5d36eb080763e\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Command name "%s" is invalid.', $name));
        }
    }
}
