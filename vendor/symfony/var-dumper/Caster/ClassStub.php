 ...
 */
class ClassStub extends \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Stub(), \true);
                $s = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
