...
use _PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\DateCaster;
 ...
 */
class DateCasterTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
...
EODUMP;
    ...
    public function testCastDateTime($time, $timezone, $xDate, $xTimestamp, $xInfos)
    {
        ...
        $date = new \DateTime($time, new \DateTimeZone($timezone));
        $cast = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\DateCaster::castDateTime($date, ['foo' => 'bar'], $stub, \false, 0);
        $xDump = <<<EODUMP
array:1 [
  "\\x00~\\x00date" => {$xDate}
]
...
EODUMP;
    ...
    {
        return [['2017-04-30 00:00:00.000000', 'Europe/Zurich', '2017-04-30 00:00:00.0 Europe/Zurich (+02:00)', 1493503200, 'Sunday, April 30, 2017%Afrom now%ADST On'], ['2017-12-31 00:00:00.000000', 'Europe/Zurich', '2017-12-31 00:00:00.0 Europe/Zurich (+01:00)', 1514674800, 'Sunday, December 31, 2017%Afrom now%ADST Off'], ['2017-04-30 00:00:00.000000', '+02:00', '2017-04-30 00:00:00.0 +02:00', 1493503200, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.100000', '+00:00', '2017-04-30 00:00:00.100 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.120000', '+00:00', '2017-04-30 00:00:00.120 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.123000', '+00:00', '2017-04-30 00:00:00.123 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.123400', '+00:00', '2017-04-30 00:00:00.123400 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.123450', '+00:00', '2017-04-30 00:00:00.123450 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now'], ['2017-04-30 00:00:00.123456', '+00:00', '2017-04-30 00:00:00.123456 +00:00', 1493510400, 'Sunday, April 30, 2017%Afrom now']];
    }
    /**
...
EODUMP;
        $this->assertDumpEquals($xDump, $interval, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
    }
    /**
     * @dataProvider provideIntervals
     */
    public function testCastInterval($intervalSpec, $ms, $invert, $xInterval, $xSeconds)
    {
        ...
        $interval = $this->createInterval($intervalSpec, $ms, $invert);
        $stub = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Stub();
        $cast = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\DateCaster::castInterval($interval, ['foo' => 'bar'], $stub, \false, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
        $xDump = <<<EODUMP
array:1 [
...
EODUMP;
    ...
    {
        return [['PT0S', 0, 0, '0s', '0s'], ['PT0S', 0.1, 0, '+ 00:00:00.100', '%is'], ['PT1S', 0, 0, '+ 00:00:01.0', '%is'], ['PT2M', 0, 0, '+ 00:02:00.0', '%is'], ['PT3H', 0, 0, '+ 03:00:00.0', '%ss'], ['P4D', 0, 0, '+ 4d', '%ss'], ['P5M', 0, 0, '+ 5m', null], ['P6Y', 0, 0, '+ 6y', null], ['P1Y2M3DT4H5M6S', 0, 0, '+ 1y 2m 3d 04:05:06.0', null], ['PT1M60S', 0, 0, '+ 00:02:00.0', null], ['PT1H60M', 0, 0, '+ 02:00:00.0', null], ['P1DT24H', 0, 0, '+ 2d', null], ['P1M32D', 0, 0, '+ 1m 32d', null], ['PT0S', 0, 1, '0s', '0s'], ['PT0S', 0.1, 1, '- 00:00:00.100', '%is'], ['PT1S', 0, 1, '- 00:00:01.0', '%is'], ['PT2M', 0, 1, '- 00:02:00.0', '%is'], ['PT3H', 0, 1, '- 03:00:00.0', '%ss'], ['P4D', 0, 1, '- 4d', '%ss'], ['P5M', 0, 1, '- 5m', null], ['P6Y', 0, 1, '- 6y', null], ['P1Y2M3DT4H5M6S', 0, 1, '- 1y 2m 3d 04:05:06.0', null], ['PT1M60S', 0, 1, '- 00:02:00.0', null], ['PT1H60M', 0, 1, '- 02:00:00.0', null], ['P1DT24H', 0, 1, '- 2d', null], ['P1M32D', 0, 1, '- 1m 32d', null]];
    }
    /**
...
EODUMP;
        $this->assertDumpMatchesFormat($xDump, $timezone, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
    }
    /**
     * @dataProvider provideTimeZones
     */
    public function testCastTimeZone($timezone, $xTimezone, $xRegion)
    {
        $timezone = new \DateTimeZone($timezone);
        $stub = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Stub();
        $cast = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\DateCaster::castTimeZone($timezone, ['foo' => 'bar'], $stub, \false, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
        $xDump = <<<EODUMP
array:1 [
...
EODUMP;
    ...
    public function testCastPeriod($start, $interval, $end, $options, $xPeriod, $xDates)
    {
        $p = new \DatePeriod(new \DateTime($start), new \DateInterval($interval), \is_int($end) ? $end : new \DateTime($end), $options);
        $stub = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Stub();
        $cast = \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\DateCaster::castPeriod($p, [], $stub, \false, 0);
        $xDump = <<<EODUMP
array:1 [
