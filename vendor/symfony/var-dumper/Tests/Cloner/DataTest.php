 ...
 */
namespace _PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Tests\Cloner;
...
class DataTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    public function testBasicData()
    {
        ...
        $clonedValues = [];
        $this->assertInstanceOf(\_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Data::class, $data);
    ...
    public function testObject()
    {
        ...
        $this->assertSame('foo', $data->{\_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message'});
        $this->assertSame('foo', $data['message']);
        $this->assertSame('foo', $data[\_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'message']);
    ...
    public function testArray()
    {
        $values = [[], [123]];
        $data = $this->cloneVar($values);
        $this->assertSame($values, $data->getValue(\true));
        $children = $data->getValue();
        $this->assertInternalType('array', $children);
        $this->assertInstanceOf(\_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Data::class, $children[0]);
        $this->assertInstanceOf(\_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\Data::class, $children[1]);
        $this->assertEquals($children[0], $data[0]);
        $this->assertEquals($children[1], $data[1]);
        $this->assertSame($values[0], $children[0]->getValue(\true));
        $this->assertSame($values[1], $children[1]->getValue(\true));
    }
    public function testStub()
    {
        $data = $this->cloneVar([new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Caster\ClassStub('stdClass')]);
        $data = $data[0];
    ...
    public function testHardRefs()
    {
        ...
        $this->assertEquals([$data[2]->getValue()], $data[2]->getValue(\true));
