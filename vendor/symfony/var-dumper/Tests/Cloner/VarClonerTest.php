 ...
 */
class VarClonerTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
...
EOTXT;
        $this->assertSame(\sprintf($expected, \PHP_INT_MAX), \print_r($clone, \true));
    }
...
(
    [data:Symfony\\Component\\VarDumper\\Cloner\\Data:private] => Array
        (
            ...
            [1] => Array
                (
                    [\0+\0001] => Symfony\\Component\\VarDumper\\Cloner\\Stub Object
                        (
                            [type] => 4
                            [class] => stdClass
                            [value] => 
                    ...
                    [\0+\0002] => Symfony\\Component\\VarDumper\\Cloner\\Stub Object
                        (
                            [type] => 4
                            [class] => stdClass
                            [value] => 
...
EOTXT;
        $this->assertStringMatchesFormat($expected, \print_r($clone, \true));
    }
...
EOTXT;
    ...
    {
        $cloner = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\VarCloner(['*' => function ($obj, $array) {
            return ['foo' => 123];
