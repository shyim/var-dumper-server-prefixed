...
use _PhpScoper5d36eb080763e\Twig\Environment;
use _PhpScoper5d36eb080763e\Twig\Loader\FilesystemLoader;
/**
 * @author Nicolas Grekas <p@tchwork.com>
 */
class CliDumperTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    ...
    public function testGet()
    {
        ...
        $cloner->addCasters([':stream' => function ($res, $a) {
...
, $out);
    ...
    {
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);
        $dumper->setColors(\false);
        $cloner = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\VarCloner();
        $var = ['array' => ['a', 'b'], 'string' => 'hello', 'multiline string' => "this\nis\na\\multiline\nstring"];
    ...
    {
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_TRAILING_COMMA);
        $dumper->setColors(\false);
        $cloner = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\VarCloner();
        $ex = new \RuntimeException('foo');
        $dump = $dumper->dump($cloner->cloneVar($ex)->withRefHandles(\false), \true);
        $this->assertStringMatchesFormat(<<<'EOTXT'
RuntimeException {
  #message: "foo"
  #code: 0
...
EOTXT;
        (yield [$expected, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR]);
        $expected = <<<'EOTXT'
array:3 [
  "array" => array:2 [
    0 => "a",
...
EOTXT;
        (yield [$expected, \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_TRAILING_COMMA]);
    }
    /**
...
, $var);
    ...
    public function testThrowingCaster()
    {
        ...
        $twig = new \_PhpScoper5d36eb080763e\__TwigTemplate_VarDumperFixture_u75a09(new \_PhpScoper5d36eb080763e\Twig\Environment(new \_PhpScoper5d36eb080763e\Twig\Loader\FilesystemLoader()));
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper();
        $dumper->setColors(\false);
        $cloner = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\VarCloner();
        $cloner->addCasters([':stream' => function ($res, $a) {
        ...
        $cloner->addCasters([':stream' => eval('return function () use ($twig) {
                try {
                    $twig->render([]);
...
, $var);
    ...
    public function testGlobals()
    {
        ...
        unset($var[0]);
        $out = '';
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\CliDumper(function ($line, $depth) use(&$out) {
            if ($depth >= 0) {
