 ...
 */
class HtmlDumperTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    public function testGet()
    {
        ...
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\HtmlDumper('php://output');
...
, $out);
    ...
    public function testCharset()
    {
        ...
        $dumper = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Dumper\HtmlDumper('php://output', 'CP1251');
        $dumper->setDumpHeader('<foo></foo>');
        $dumper->setDumpBoundaries('<bar>', '</bar>');
        $cloner = new \_PhpScoper5d36eb080763e\Symfony\Component\VarDumper\Cloner\VarCloner();
        $data = $cloner->cloneVar($var);
