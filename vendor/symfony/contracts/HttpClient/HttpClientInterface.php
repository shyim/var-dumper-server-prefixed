...
use _PhpScoper5d36eb080763e\Symfony\Contracts\HttpClient\Test\HttpClientTestCase;
/**
...
interface HttpClientInterface
{
    public const OPTIONS_DEFAULTS = [
        ...
        'json' => null,
        // array|\JsonSerializable - when set, implementations MUST set the "body" option to
        ...
        'max_redirects' => 20,
        // int - the maximum number of redirects to follow; a value lower or equal to 0 means
        ...
        'buffer' => \true,
        // bool - whether the content of the response should be buffered or not
        'on_progress' => null,
        ...
        'timeout' => null,
        // float - the inactivity timeout - defaults to ini_get('default_socket_timeout')
        'bindto' => '0',
     ...
     */
    public function request(string $method, string $url, array $options = []) : \_PhpScoper5d36eb080763e\Symfony\Contracts\HttpClient\ResponseInterface;
    /**
     ...
     */
    public function stream($responses, float $timeout = null) : \_PhpScoper5d36eb080763e\Symfony\Contracts\HttpClient\ResponseStreamInterface;
}
