...
class ServiceLocatorTest extends \_PhpScoper5d36eb080763e\PHPUnit\Framework\TestCase
{
    public function getServiceLocator(array $factories)
    {
        return new class($factories) implements \_PhpScoper5d36eb080763e\Psr\Container\ContainerInterface
        {
