...
class SqlFormatter
{
     ...
     */
    public static function format($string, $highlight = \true)
    {
        ...
        $return = \trim(\str_replace("\t", self::$tab, $return));
        if ($highlight) {
 ...
 * @version    1.2.17
 */
\class_alias('_PhpScoper5d36eb080763e\\SqlFormatter', 'SqlFormatter', \false);
