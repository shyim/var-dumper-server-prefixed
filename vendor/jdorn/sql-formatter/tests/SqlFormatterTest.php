...
\_PhpScoper5d36eb080763e\SqlFormatter::$cli = \false;
class SqlFormatterTest extends \_PhpScoper5d36eb080763e\PHPUnit_Framework_TestCase
{
    protected $sqlData;
    /**
    ...
    {
        $this->assertEquals(\trim($html), \trim(\_PhpScoper5d36eb080763e\SqlFormatter::format($sql)));
    }
    /**
    ...
    {
        $this->assertEquals(\trim($html), \trim(\_PhpScoper5d36eb080763e\SqlFormatter::format($sql, \false)));
    }
    /**
    ...
    {
        $this->assertEquals(\trim($html), \trim(\_PhpScoper5d36eb080763e\SqlFormatter::highlight($sql)));
    }
    /**
    ...
    {
        \_PhpScoper5d36eb080763e\SqlFormatter::$cli = \true;
        $this->assertEquals(\trim($html), \trim(\_PhpScoper5d36eb080763e\SqlFormatter::format($sql)));
        \_PhpScoper5d36eb080763e\SqlFormatter::$cli = \false;
    }
    /**
    ...
    {
        $this->assertEquals(\trim($html), \trim(\_PhpScoper5d36eb080763e\SqlFormatter::compress($sql)));
    }
    function testUsePre()
    {
        \_PhpScoper5d36eb080763e\SqlFormatter::$use_pre = \false;
        $actual = \_PhpScoper5d36eb080763e\SqlFormatter::highlight("test");
        $expected = '<span style="color: #333;">test</span>';
        $this->assertEquals($actual, $expected);
        \_PhpScoper5d36eb080763e\SqlFormatter::$use_pre = \true;
        $actual = \_PhpScoper5d36eb080763e\SqlFormatter::highlight("test");
    ...
    {
        $expected = array("SELECT 'test' FROM MyTable;", "SELECT Column2 FROM SomeOther Table WHERE (test = true);");
        $actual = \_PhpScoper5d36eb080763e\SqlFormatter::splitQuery(\implode(';', $expected));
    ...
    function testSplitQueryEmpty()
    {
        ...
        $actual = \_PhpScoper5d36eb080763e\SqlFormatter::splitQuery($sql);
        $this->assertEquals($expected, $actual);
    }
    function testRemoveComments()
    {
        $expected = \_PhpScoper5d36eb080763e\SqlFormatter::format("SELECT\n * FROM\n MyTable", \false);
        $sql = "/* this is a comment */SELECT#This is another comment\n * FROM-- One final comment\n MyTable";
        $actual = \_PhpScoper5d36eb080763e\SqlFormatter::removeComments($sql);
        $this->assertEquals($expected, $actual);
    }
    function testCacheStats()
    {
        $stats = \_PhpScoper5d36eb080763e\SqlFormatter::getCacheStats();
...
\class_alias('_PhpScoper5d36eb080763e\\SqlFormatterTest', 'SqlFormatterTest', \false);
